...
# Create User Model
class Users(PaginatedAPIMixin,db.Model,UserMixin):
    ...
    # Create a python dictionary that converts the Users object to python dictionary
    ...
    # Convert a python dictionary to a model
